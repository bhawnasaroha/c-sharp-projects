...
public partial class _Default : System.Web.UI.Page
{
    ...
    {        
        connectDB.Open();
        SqlDataAdapter insertInBank = new SqlDataAdapter("INSERT INTO Bank VALUES ("+bid.Text+", '"+bname.Text+"')",connectDB);
    ...
    protected void bid_TextChanged(object sender, EventArgs e)
    {
